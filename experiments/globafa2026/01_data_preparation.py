...
def _(mo):
    mo.md("""
    # globafa2026 — Lending Club (P2P)

    This notebook downloads the Lending Club dataset from Zenodo and prepares
    a cleaned Parquet file for conformal prediction experiments.
...
def _(mo):
    ...
    and convert `issue_d` from string to date for the temporal split.
...
def _(EXPERIMENT_DIR, df_clean):
    ...
    cleaned_path = CLEANED_DIR / "globafa2026.parquet"
